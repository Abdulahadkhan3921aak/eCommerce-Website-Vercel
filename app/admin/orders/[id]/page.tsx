...
export default function AdminOrderDetailsPage() {
    ...
    const handleGeneratePaymentLink = async (sendEmail: boolean = true) => {
        try {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-8 bg-white rounded-lg shadow p-6">
                    ...
                    {['approved', 'pending_payment_adjustment', 'shipping_calculated'].includes(order.status) && (
                        <div className="mb-4">
                            <button
                                onClick={() => {
                                    showPopup({
                                        title: 'Generate Payment Link',
                                        message: 'Send payment link to customer?',
                                        type: 'confirm',
                                        component: (
                                            <div className="flex items-center space-x-2">
                                                <input
                                                    type="checkbox"
                                                    id="send-email-detail"
                                                    defaultChecked={true}
                                                    className="rounded border-gray-300 text-purple-600"
                                                />
                                                <label htmlFor="send-email-detail" className="text-sm text-gray-700">
                                                    Send via email
                                                </label>
                                            </div>
                                        ),
                                        actions: [
                                            ...
                                            },
                                            {
                                                label: 'Generate',
                                                action: () => {
                                                    const sendEmail = (document.getElementById('send-email-detail') as HTMLInputElement)?.checked ?? true
                                                    handleGeneratePaymentLink(sendEmail)
                                                },
                                                variant: 'primary'
                                            }
                                        ]
                    ...
                    {/* Payment link details will be shown here after generation */}
                </div>
            </div>
        </div>
    )
